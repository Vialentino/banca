...
public class CartaCredito {
	...
	public CartaCredito(String pin, CC cc, String intestatario, String scadenza, Sportello sportello, double commissione, double GI, double GO, double MI, double MO){
		this.pin = pin;
		this.cc = cc;
